...
var ElectronicsLibrary = function () {
    var _a = react_1.useState('components'), activeTab = _a[0], setActiveTab = _a[1];
    ...
    var categories = __spreadArrays(['all'], Array.from(new Set(components.map(function (c) { return c.category; }))));
    var filteredComponents = components.filter(function (component) {
        ...
        var matchesSearch = component.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    var ComponentCard = function (_a) {
        ...
        return (react_1["default"].createElement("div", { style: {
            ...
            react_1["default"].createElement("div", { style: { textAlign: 'center', marginBottom: '15px' } },
                react_1["default"].createElement("div", { style: { fontSize: '3rem', marginBottom: '10px' } }, component.image),
                react_1["default"].createElement("h3", { style: { color: '#333', margin: '0 0 5px 0', fontSize: '18px' } }, component.name),
            ...
            react_1["default"].createElement("p", { style: { color: '#6B7280', fontSize: '14px', lineHeight: '1.5', marginBottom: '15px' } }, component.description),
            react_1["default"].createElement("div", { style: { marginBottom: '15px' } },
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px' } }, "Voltage: "),
                react_1["default"].createElement("span", { style: { color: '#6B7280', fontSize: '14px' } }, component.voltage)),
            react_1["default"].createElement("div", { style: { marginBottom: '15px' } },
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px' } }, "Price: "),
                react_1["default"].createElement("span", { style: { color: '#059669', fontSize: '14px', fontWeight: '600' } }, component.price)),
            react_1["default"].createElement("div", { style: { marginBottom: '15px' } },
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px', display: 'block', marginBottom: '8px' } }, "Key Pins:"),
                react_1["default"].createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '5px' } }, component.pins.slice(0, 4).map(function (pin, index) { return (react_1["default"].createElement("span", { key: index, style: {
                        background: '#3B82F6',
                        color: 'white',
                        padding: '2px 8px',
                        borderRadius: '10px',
            ...
            react_1["default"].createElement("div", null,
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px', display: 'block', marginBottom: '8px' } }, "Applications:"),
                react_1["default"].createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '5px' } }, component.applications.slice(0, 2).map(function (app, index) { return (react_1["default"].createElement("span", { key: index, style: {
                        background: '#F3F4F6',
                        color: '#374151',
                        padding: '2px 8px',
                        borderRadius: '8px',
    ...
    var ProjectCard = function (_a) {
        ...
        return (react_1["default"].createElement("div", { style: {
            ...
            react_1["default"].createElement("div", { style: { textAlign: 'center', marginBottom: '15px' } },
                react_1["default"].createElement("div", { style: { fontSize: '3rem', marginBottom: '10px' } }, project.image),
                react_1["default"].createElement("h3", { style: { color: '#333', margin: '0 0 5px 0', fontSize: '18px' } }, project.name),
                react_1["default"].createElement("div", { style: { display: 'flex', justifyContent: 'center', gap: '10px', marginBottom: '10px' } },
                    react_1["default"].createElement("div", { style: {
            ...
            react_1["default"].createElement("p", { style: { color: '#6B7280', fontSize: '14px', lineHeight: '1.5', marginBottom: '15px' } }, project.description),
            react_1["default"].createElement("div", { style: { marginBottom: '15px' } },
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px', display: 'block', marginBottom: '8px' } }, "Required Components:"),
                react_1["default"].createElement("div", { style: { fontSize: '13px', color: '#6B7280' } }, project.components.join(', '))),
            react_1["default"].createElement("div", { style: { marginBottom: '15px' } },
                react_1["default"].createElement("strong", { style: { color: '#374151', fontSize: '14px', display: 'block', marginBottom: '8px' } }, "Skills Learned:"),
                react_1["default"].createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '5px' } }, project.skills.map(function (skill, index) { return (react_1["default"].createElement("span", { key: index, style: {
                        background: '#EDE9FE',
                        color: '#7C3AED',
                        padding: '2px 8px',
                        borderRadius: '8px',
    ...
    return (react_1["default"].createElement("div", { style: {
        ...
        react_1["default"].createElement("div", { style: { textAlign: 'center', marginBottom: '30px' } },
            ...
            react_1["default"].createElement("p", { style: { color: '#6B7280', fontSize: '16px', animation: 'slideInDown 0.8s ease-out' } }, "Comprehensive guide to electronic components and hands-on projects")),
        react_1["default"].createElement("div", { style: {
                display: 'flex',
                ...
                marginBottom: '30px',
                animation: 'slideInUp 0.6s ease-out'
            } }, ['components', 'projects', 'dictionary'].map(function (tab) { return (react_1["default"].createElement("button", { key: tab, onClick: function () { return setActiveTab(tab); }, style: {
        ...
        activeTab === 'components' && (react_1["default"].createElement("div", { style: { animation: 'fadeIn 0.5s ease-out' } },
            react_1["default"].createElement("div", { style: {
                    display: 'flex',
                    gap: '20px',
                    marginBottom: '30px',
                ...
                react_1["default"].createElement("input", { type: "text", placeholder: "Search components...", value: searchTerm, onChange: function (e) { return setSearchTerm(e.target.value); }, style: {
                        flex: 1,
                        minWidth: '250px',
                        padding: '12px 16px',
                ...
                react_1["default"].createElement("select", { value: selectedCategory, onChange: function (e) { return setSelectedCategory(e.target.value); }, style: {
                        padding: '12px 16px',
                        border: '2px solid #E5E7EB',
                        borderRadius: '25px',
                        fontSize: '16px',
                        outline: 'none',
                        cursor: 'pointer'
                    } }, categories.map(function (category) { return (react_1["default"].createElement("option", { key: category, value: category }, category === 'all' ? 'All Categories' : category)); }))),
            react_1["default"].createElement("div", { style: {
                    display: 'grid',
                    gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))',
                    gap: '25px'
                } }, filteredComponents.map(function (component, index) { return (react_1["default"].createElement("div", { key: component.id, style: { animationDelay: index * 0.1 + "s" } },
                react_1["default"].createElement(ComponentCard, { component: component }))); })))),
        activeTab === 'projects' && (react_1["default"].createElement("div", { style: { animation: 'fadeIn 0.5s ease-out' } },
            react_1["default"].createElement("div", { style: {
                    display: 'grid',
                    gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))',
                    gap: '25px'
                } }, projects.map(function (project, index) { return (react_1["default"].createElement("div", { key: project.id, style: { animationDelay: index * 0.1 + "s" } },
                react_1["default"].createElement(ProjectCard, { project: project }))); })))),
        activeTab === 'dictionary' && (react_1["default"].createElement("div", { style: { animation: 'fadeIn 0.5s ease-out' } },
            react_1["default"].createElement("div", { style: {
                    display: 'grid',
            ...
            ].map(function (item, index) { return (react_1["default"].createElement("div", { key: index, style: {
                    background: 'white',
                    borderRadius: '12px',
                    padding: '20px',
                    boxShadow: '0 4px 15px rgba(0,0,0,0.1)',
